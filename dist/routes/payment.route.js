...
import { pay, handlePayWebHook, paymentHistory, edit, bulkEdit, viewSingle, addNote, analytics, studentPurchases, } from "../controllers/payment.controller.js";
...
router.get("/student-purchases", authorize, restrictTo("admin"), studentPurchases);
...
router.post("/single-order/:orderId/notes", authorize, restrictTo("admin"), addNote);
