...
router.put("/user/:id/deactivate-user", authorize, restrictTo("admin"), deactivateToUser);
router.put("/user/:id/suspend-user", authorize, restrictTo("admin"), suspendToUser);
router.put("/user/:id/activate-user", authorize, restrictTo("admin"), activateToUser);
...
router.put("/edit-profile", authorize, upload.fields([
...
router.post("/invite/csv", authorize, restrictTo("admin"), upload.single("file"), inviteUserCsv);
