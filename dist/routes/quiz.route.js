...
import { createQuestion, create, submit, getAll, getSingle, update, remove, results, } from "../controllers/quiz.controller.js";
...
router.put("/quiz/:quizId", authorize, restrictTo("admin", "instructor"), update);
router.delete("/quiz/:quizId", authorize, restrictTo("admin", "instructor"), remove);
