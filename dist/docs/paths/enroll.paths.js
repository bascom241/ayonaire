...
export default {
    ...
    "/api/v1/enrollment/enrolled-coures": {
        get: {
            ...
            description: "Legacy misspelled route kept for backward compatibility. Use /api/v1/enrollment/enrolled-courses instead.",
            deprecated: true,
            security: [{ bearerAuth: [] }],
            responses: {
                200: {
    ...
    "/api/v1/enrollment/admin/enroll-csv": {
        post: {
            ...
            description: "Uploads a CSV of student emails and enrolls them into a course. Admin only.",
            security: [{ bearerAuth: [] }],
            requestBody: {
                required: true,
                content: {
    ...
    "/api/v1/enrollment/course/{courseId}": {
        get: {
            ...
            description: "Returns the authenticated user's enrollment and progress detail for a specific course.",
            security: [{ bearerAuth: [] }],
            parameters: [
                {
                    in: "path",
