...
export const listMyRooms = async (userId) => {
    ...
    const lastMessageByRoom = new Map(lastMessages.map((item) => [item._id.toString(), item.message]));
...
export const isRoomParticipant = async (roomId, userId) => {
